        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RouteStations_BusStations_BusStationId",
                        column: x => x.BusStationId,
                        principalTable: "BusStations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RouteStations_TripRoutes_TripRouteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_TripRoutes_TripRouteId",
                        column: x => x.TripRouteId,
                        principalTable: "TripRoutes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ShiftAssignments_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Tickets_ShiftAssignments_ShiftAssignmentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RouteStations_BusStationId",
                table: "RouteStations",
                column: "BusStationId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteStations_TripRouteId",
                table: "RouteStations",
                column: "TripRouteId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_DriverId",
                table: "ShiftAssignments",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_TripRouteId",
                table: "ShiftAssignments",
                column: "TripRouteId");

            migrationBuilder.CreateIndex(
                name: "IX_ShiftAssignments_VehicleId",
                table: "ShiftAssignments",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_ShiftAssignmentId",
                table: "Tickets",
